...
public class WordCount_06 {
    public static void main(String[] args) throws IOException {
        Scanner wordScanner = new Scanner(new FileReader("src/Exercises Resources/words.txt"));
        ...
        Scanner fileScanner = new Scanner(new FileReader("src/Exercises Resources/text.txt"));
        ...
        PrintWriter pw = new PrintWriter(new FileWriter("src/Exercises Resources/result.txt"));
        map.entrySet()
